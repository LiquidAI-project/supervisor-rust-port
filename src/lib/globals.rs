...
use crate::lib::trap::{Result, Trap};
use crate::lib::value::{LittleEndian, Value};
use crate::lib::wain_ast::{Global, GlobalKind, InsnKind, ValType};
...
mod tests {
    use super::*;
    use crate::lib::trap::TrapReason;
    use std::borrow::Cow;
    use crate::lib::wain_ast::{Import, InsnKind, Instruction, Name, ValType};
